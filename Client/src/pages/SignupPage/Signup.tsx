...
function Signup() {
    ...
    const btnClicked = (e: any) => {
        e.preventDefault()
        axios.post('http://localhost:8080/signup', { name, username, password, confirmPassword })
            ...
            <div className='form-container'>
                <div className='signup-heading'>
                    ...
                    <form className="form">
                        ...
                        <button type="submit" onClick={btnClicked} className="form-btn">Sign Up </button>
                    </form>
                    <div>
                    ...
                    <div className="buttons-container">
                        <div className="apple-login-button">
                            ...
                            <span className='apple-icon-span'>Signup with Apple</span>
                        </div>
                        <div className="google-login-button">
                            ...
                            <span className='google-icon-span'>Signup with Google</span>
                        </div>
                    </div>
                </div>
            </div >
...
// <label classNameName="blackText">
//     Username:
//     <input type="text" classNameName="username-container" value={username} onChange={(e) => setUsername(e.target.value)} />
// </label>

// <br />
// <label classNameName="blackText">
//     Password:
//     <input type="password" classNameName="password-container" value={password} onChange={(e) => setPassword(e.target.value)} />
// </label>
// <br />
