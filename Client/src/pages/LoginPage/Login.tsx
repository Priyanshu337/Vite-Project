...
function Login() {
    ...
    const handleSubmit = () => {
        axios.post('https://localhost:8080/login', { email, password })
            .then(response => {
                console.log(response)
                if (response.data === "success") {
                    navigate('/Home')
                } else {
                    console.log(response.data.message); // Log or handle the error message
                }
            })
            ...
            <div className='login-form'>
                ...
                <div className="buttons-container">
                    <div className="apple-login-button">
                        ...
                        <span className='apple-icon-span'>Log in with Apple</span>
                    </div>
                    <div className="google-login-button">
                        ...
                        <span className='google-icon-span'>Log in with Google</span>
                    </div>
                </div>
            </div>
        </div >
